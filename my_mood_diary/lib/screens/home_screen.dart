...
import 'package:my_mood_diary/models/mood_card.dart';
import 'package:my_mood_diary/models/mood_data.dart';
import 'package:my_mood_diary/service/db_helper.dart';
import 'package:my_mood_diary/widgets/moodday_card.dart';
                              ...
                              snapshot.data[position]['mood'] == 'Angry'
                                  ...
                                  : snapshot.data[position]['mood'] == 'Happy'
                                      ...
                                      : snapshot.data[position]['mood'] == 'Sad'
                                          ...
                                          : snapshot.data[position]['mood'] == 'Surprised' ? charts.ColorUtil.fromDartColor(Colors.pink) : snapshot.data[position]['mood'] == 'Loving' ? charts.ColorUtil.fromDartColor(Colors.purple) : snapshot.data[position]['mood'] == 'Scared' ? charts.ColorUtil.fromDartColor(Colors.black) : charts.ColorUtil.fromDartColor(Colors.white)));
